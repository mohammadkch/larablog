                    ...
                    <div class="card-body p-0">
                        <div class="category-slider no-arrow">
                            <div>
                                <div class="dashboard-category">
                                    <a href="javascript:void(0)" class="category-image">
                                        <img src="{{ asset('assets/back/svg/vegetable.svg') }}" class="img-fluid" alt="">
                                    </a>
                            ...
                            <div>
                                <div class="dashboard-category">
                                    <a href="javascript:void(0)" class="category-image">
                                        <img src="{{ asset('assets/back/svg/cup.svg') }}" class="img-fluid" alt="">
                                    </a>
                                    <a href="javascript:void(0)" class="category-name">
                                        <h6>نوشیدنی ها</h6>
                                    </a>
                            ...
                            <div>
                                <div class="dashboard-category">
                                    <a href="javascript:void(0)" class="category-image">
                                        <img src="{{ asset('assets/back/svg/meats.svg') }}" class="img-fluid" alt="">
                                    </a>
                                    <a href="javascript:void(0)" class="category-name">
                            ...
                            <div>
                                <div class="dashboard-category">
                                    <a href="javascript:void(0)" class="category-image">
                                        <img src="{{ asset('assets/back/svg/breakfast.svg') }}" class="img-fluid" alt="">
                                    </a>
                                    <a href="javascript:void(0)" class="category-name">
                                        <h6>صبحانه</h6>
                                    </a>
                            ...
                            <div>
                                <div class="dashboard-category">
                                    <a href="javascript:void(0)" class="category-image">
                                        <img src="{{ asset('assets/back/svg/frozen.svg') }}" class="img-fluid" alt="">
                                    </a>
                                    <a href="javascript:void(0)" class="category-name">
                                        <h6>غذای یخ زده</h6>
                                    </a>
                            ...
                            <div>
                                <div class="dashboard-category">
                                    <a href="javascript:void(0)" class="category-image">
                                        <img src="{{ asset('assets/back/svg/milk.svg') }}" class="img-fluid" alt="">
                                    </a>
                                    <a href="javascript:void(0)" class="category-name">
                                        <h6>شیر و لبنیات</h6>
                                    </a>
                            ...
                            <div>
                                <div class="dashboard-category">
                                    <a href="javascript:void(0)" class="category-image">
                                        <img src="{{ asset('assets/back/svg/pet.svg') }}" class="img-fluid" alt="">
                                    </a>
                                    <a href="javascript:void(0)" class="category-name">
                        ...
                        <div class="best-selling-box d-sm-flex d-none">
                            ...
                            <div class="dropdown">
                                <button class="btn p-0 dropdown-toggle" type="button"
                                        ...
                                        data-bs-auto-close="true">تاریخ</button>
                                ...
                                <table class="best-selling-table w-image
                                        ...
                                        <td>
                                            <div class="best-product-box">
                                                <div class="product-image">
                                                    <img src="{{ asset('assets/back/images/product/1.png') }}"
                                    ...
                                    <tr>
                                        <td>
                                            <div class="best-product-box">
                                                <div class="product-image">
                                                    <img src="{{ asset('assets/back/images/product/2.png') }}"
                                                         class="img-fluid" alt="Product">
                                                </div>
                                                <div class="product-name">
                                                    <h5>دلستر</h5>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="best-product-box">
                                                <div class="product-image">
                                                    <img src="{{ asset('assets/back/images/product/3.png') }}"
                                                         class="img-fluid" alt="Product">
                                                </div>
                                                <div class="product-name">
                                                    <h5>کیک</h5>
